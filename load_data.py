...
# dataset_lidar = 'data/train/train_lidar0.mat'
# dataset_joint = 'data/train/train_joint0.mat'
# lidar_data = load_lidar_data(dataset_lidar)
# joint_data = load_joint_data(dataset_joint)
# show_lidar(lidar_data)